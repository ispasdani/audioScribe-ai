...
const GradientButton = ({ title, onClickEvent }: GradientButtonProps) => {
  return (
    ...
    >
      ...
      <span className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-full bg-blue-800 px-3 py-1 text-md font-medium text-white backdrop-blur-3xl">
        {title}
      </span>
    </button>
  );
